# -*- coding: utf-8 -*-
"""
Created on Tue Apr 21 09:54:50 2026
...
class MILFisheryDataset(Dataset):
    def __init__(self, path_phys, path_chl, df_catch, features, mask_path, is_train=False):
        ...
        #Fusion des variables sur la même grille spatio-temporelle
    ...
    def __getitem__(self, idx):
        ...
        #Découpe spatio-temporelle sur le mois réel
        ...
        for feat in self.features:
            val = ds_block[feat].values #shape : [num_days, 12, 12]
            
            #LOGARITHME SUR LA CHLOROPHYLLE
            if feat == 'CHL':
                #On applique le log pour les valeurs
        ...
        #CIBLE EN LOGARITHME
        #modèle apprendra à prédire un ordre de grandeur au lieu des vrais kilos
