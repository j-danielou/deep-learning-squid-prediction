# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 11:01:20 2026
...
class WeeklyMILModel(nn.Module):
    def __init__(self, in_channels, hidden_dim):
        ...
        #prédiction 2 tetes
        self.head_presence = nn.Linear(hidden_dim, 1)   #proba habitat
        self.head_abundance = nn.Linear(hidden_dim, 1)  #tonnage
