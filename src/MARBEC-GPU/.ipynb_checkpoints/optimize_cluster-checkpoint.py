...
BASE_DIR = "/home/jdanielou"
PATH_CSV = os.path.join(BASE_DIR, "data/input/v1960_2026-05-05_fishing-activity-monthly-catch-1x1.csv")
PATH_PHYS = os.path.join(BASE_DIR, "data/input/tensors_annuels/phy/")
PATH_CHL = os.path.join(BASE_DIR, "data/input/tensors_annuels/bio/")
PATH_MASK = os.path.join(BASE_DIR, "data/input/official_mask_zee.nc")
DOSSIER_MODELS = os.path.join(BASE_DIR, "data/output/models/")
MLFLOW_DIR = os.path.join(BASE_DIR, "data/output/runs/mlflow")
